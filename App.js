...
import AdvancedSearch from './src/pages/AdvancedSearch';
...
const AppContent = ({ selectedDataset, onLogout, onDatasetChange, currentRoute }) => {
  const shouldShowFooter = currentRoute !== 'SearchVoters';
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Stack.Screen name="AdvancedSearch">
            {(props) => <AdvancedSearch {...props} selectedDataset={selectedDataset} />}
          </Stack.Screen>
          ...
          <Stack.Screen name="Analysis">
            {(props) => <Analysis {...props} selectedDataset={selectedDataset} />}
          </Stack.Screen>
